...
> Mise is used both in the ds-template project itself and in all generated projects.
> See [Mise](tmp_content/mise.md) for detailed setup and usage instructions.
...
For detailed information about each package type and monorepo structure, see [Project Structure](tmp_content/project_structure.md).

## Detailed Documentation

- [Project Structure](tmp_content/project_structure.md) - Monorepo and package organization
- [Code Quality](tmp_content/precommit.md) - Ruff-based linting and formatting
- [Mise](tmp_content/mise.md) - Environment management and tooling
