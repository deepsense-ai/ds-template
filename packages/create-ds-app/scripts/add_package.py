...
def test_add_cli_package(project_path: str):
    ...
    print(f"Testing add_package function...")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Test CLI and library package generation in a DS project."
    )
    parser.add_argument(
        "project_path",
        type=str,
        help="Path to the project directory where packages should be created."
    )
